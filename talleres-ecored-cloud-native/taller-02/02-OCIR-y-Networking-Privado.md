...
![Datos de la tenancy: región de origen y Object Storage Namespace]( paso-1-1-tenancy-namespace.png)
...
![Acceso a Container Registry en el compartimento ecored-dev]( paso-1-2-container-registry.png)
...
![Formulario inicial para crear un repository]( paso-1-2-formulario-crear-repository.png)
...
![Formulario configurado con el compartimento y el nombre del repository]( paso-1-2-formulario-configurado.png)
...
![Repository creado con acceso privado]( paso-1-2-repository-creado-private.png)
...
![Detalles del repository con los datos de identidad redactados]( paso-1-2-repository-detalles-redactado.png)
...
![Menú de perfil con los datos de identidad redactados]( paso-1-3-menu-perfil-redactado.png)
...
![Pestaña Tokens and keys con la identidad y el fingerprint redactados]( paso-1-3-tokens-and-keys-redactado.png)
...
![Formulario para generar el Auth Token]( paso-1-3-generar-token.png)
...
![Confirmación de generación con el valor del token oculto]( paso-1-3-token-generado-oculto.png)
...
![Auth Token creado y fingerprint de la API key redactado]( paso-1-3-auth-token-creado-redactado.png)
...
![Inicio de sesión exitoso con el nombre de usuario redactado]( paso-1-4-login-succeeded-redactado.png)
...
![Descarga exitosa de la imagen desde Docker Hub]( paso-1-5-pull-docker-hub.png)
...
![Publicación exitosa de la imagen en OCIR]( paso-1-6-push-exitoso.png)
...
![Ruta de navegación hacia Container Registry]( paso-1-6-navegar-container-registry.png)
...
![Repository privado disponible en Container Registry](paso-1-6-seleccionar-repository.png)
...
![Tag v1.0 publicado en Image versions](paso-1-6-image-version-v1.png)
...
![Sección NAT Gateways dentro de la pestaña Gateways](paso-2-1-gateways-nat-vacio.png)
...
![Formulario de creación del NAT Gateway](paso-2-1-crear-nat-gateway.png)
...
![NAT Gateway disponible con la IP pública redactada](paso-2-1-nat-available-ip-redactada.png)
...
![Formulario de creación del Service Gateway](paso-2-2-crear-service-gateway.png)
...
![Service Gateway disponible](paso-2-2-service-gateway-available.png)
...
![Route Rules completas de la tabla privada]( paso-2-3-route-rules-completas.png)
...
![Nombre, tipo y CIDR de la subnet privada](paso-2-4-subnet-nombre-cidr.png)
...
![Route Table, acceso privado y DNS de la subnet]( paso-2-4-subnet-ruta-acceso-dns.png)
...
![Security List y resource logging de la subnet](paso-2-4-subnet-security-list.png)
...
![Subnets pública y privada disponibles](paso-2-4-subnet-available.png)
...
![Sección Network Security Groups dentro de Security](paso-2-5-navegar-nsg.png)
...
![Formulario del NSG sin reglas iniciales]( paso-2-5-crear-nsg-sin-reglas.png)
...
![Network Security Group disponible]( paso-2-5-nsg-available.png)
...
![Selección de ecored-vcn y acceso al VCN routing map]( paso-2-6-buscar-vcn-mapa-redactada.png)
...
![Mapa de enrutamiento de ecored-vcn con sus dos subnets y gateways]( paso-2-6-vcn-routing-map.png)
