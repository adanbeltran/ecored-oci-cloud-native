...
2. Seleccione la base y confirme que esté disponible.
...
```sql
CREATE USER ecored IDENTIFIED BY "UNA_CLAVE_SEGURA" QUOTA UNLIMITED ON DATA;
GRANT CREATE SESSION, CREATE TABLE, CREATE SEQUENCE TO ecored;
```
...
Ejecute las imágenes en este orden:
